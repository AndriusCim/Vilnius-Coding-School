...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
		...
		wp_register_script('core', ASSETS_URL . '/assets/js/core.js', array('jquery'), false, true);
...
function theme_stylesheets(){
	...
	if( defined('ASSETS_URL') ) {
		...
		wp_register_style('stylesheet', ASSETS_URL . '/assets/fonts/stylesheet.css', array('normalize'), false, 'all');
		wp_register_style('core', ASSETS_URL . '/assets/css/core.css', array('stylesheet'), false, 'all');
		
		//Loading
		wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Playfair+Display', array(), PARENT_THEME_VERSION );
...
// add_image_size("pavadinimas", plotis, aukstis, ar_kirpti);
